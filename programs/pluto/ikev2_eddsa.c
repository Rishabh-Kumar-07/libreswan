...
bool authsig_using_EDDSA_ikev2_pubkey(const struct crypt_mac *hash, const struct crypt_mac_d *hashd, shunk_t signature,
				      struct pubkey *kr,
					     ...
					     const struct hash_desc *hash_algo)
{
	...
	struct crypt_mac_d calc_hash = v2_eddsa_calculate_sighash(ike, idhash, hash_algo,
							  REMOTE_PERSPECTIVE);
	diag_t d = authsig_and_log_using_pubkey(ike, NULL, &calc_hash, signature, hash_algo,
						&pubkey_type_eddsa,
