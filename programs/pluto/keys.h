...
typedef bool (authsig_using_pubkey_fn) (const struct crypt_mac *hash, const struct crypt_mac_d *dhash,
					shunk_t signature,
					struct pubkey *kr,
...
extern diag_t authsig_and_log_using_pubkey(struct ike_sa *ike, const struct crypt_mac_d *dhash,
